...
function FeaturedCard({ project }) {
  return (
    <motion.div
      variants={fadeUp}
      className="glass rounded-xl p-6 sm:p-8 md:p-10 relative overflow-hidden group"
    ...
    >
      ...
      <div className="relative flex flex-col gap-5 sm:gap-6">
        ...
        {/* Links row — always horizontal on any screen */}
...
function ProjectCard({ project, index }) {
  return (
    <motion.div
      variants={fadeUp}
      className="glass rounded-xl p-5 sm:p-6 flex flex-col justify-between group relative overflow-hidden"
      whileHover={{ y: -4 }}
      transition={{ duration: 0.2 }}
    >
      <div
      ...
      <div className="relative flex flex-wrap gap-1.5 mt-4 sm:mt-5">
        {project.tech.map((t) => (
          <span
            key={t}
