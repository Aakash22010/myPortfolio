    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-20"
      ...
      <motion.div initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }}
        ...
        <h1 className="font-bold leading-none tracking-tight"
          style={{ fontSize: "clamp(6rem, 20vw, 12rem)", color: "var(--accent)", opacity: 0.15 }}>
          404
        </h1>
        <div className="font-bold text-2xl md:text-4xl -mt-8 relative z-10" style={{ color: "var(--text)" }}>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        className="glass rounded-xl overflow-hidden w-full max-w-md mb-10">
        ...
        <div className="px-5 py-4 space-y-2 min-h-[140px]">
          {lines.map((line, i) => (
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <Link to="/"
          className="group relative flex items-center gap-2 px-6 py-3 overflow-hidden border-2 rounded-full text-sm font-semibold transition-all duration-300"
          ...
          <span className="relative z-10 group-hover:text-white transition-colors duration-300">← Go Home</span>
        </Link>

        <Link to="/#projects"
          className="mono text-sm px-6 py-3 rounded-full glass transition"
      ...
      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}
        ...
        className="mono text-xs mt-12" style={{ color: "var(--muted)" }}>
        aakash.dev / 404
      </motion.p>
    </div>
  );
